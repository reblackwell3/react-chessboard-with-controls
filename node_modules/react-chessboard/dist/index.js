...
const ChessboardProvider = react.forwardRef(({ allowDragOutsideBoard = true, animationDuration = 300, areArrowsAllowed = true, arePiecesDraggable = true, arePremovesAllowed = false, autoPromoteToQueen = false, boardOrientation = "white", boardWidth, children, clearPremovesOnRightClick = true, customArrows, customArrowColor = "rgb(255,170,0)", customBoardStyle, customNotationStyle, customDarkSquareStyle = { backgroundColor: "#B58863" }, customDropSquareStyle = {
    ...
    const [previousTimeout, setPreviousTimeout] = react.useState();
...
function Piece({ isPremovedPiece = false, piece, square, squares, }) {
    ...
    return (jsxRuntime.jsx("div", Object.assign({ ref: arePiecesDraggable && canDrag ? drag : null, onClick: () => onPieceClick(piece, square), "data-piece": piece, style: pieceStyle }, { children: typeof chessPieces[piece] === "function" ? (chessPieces[piece]({
            squareWidth: boardWidth / 8,
            isDragging,
            square,
        })) : (jsxRuntime.jsx("svg", Object.assign({ viewBox: "1 1 43 43", width: boardWidth / 8, height: boardWidth / 8, style: { display: "block" } }, { children: jsxRuntime.jsx("g", { children: chessPieces[piece] }) }))) })));
}
...
function Square({ square, squareColor, setSquares, squareHasPremove, children, }) {
    ...
    return (jsxRuntime.jsx("div", Object.assign({ ref: drop, style: defaultSquareStyle, "data-square-color": squareColor, "data-square": square, onTouchMove: (e) => {
            var _a;
...
function Squares() {
    ...
    const premovesHistory = react.useMemo(() => {
        const result = [];
...
const Arrows = () => {
    ...
    return (jsxRuntime.jsx("svg", Object.assign({ width: boardWidth, height: boardWidth, style: {
            position: "absolute",
            top: "0",
            left: "0",
            pointerEvents: "none",
...
function PromotionOption({ option }) {
    ...
    return (jsxRuntime.jsx("div", Object.assign({ onClick: () => {
        ...
        } }, { children: typeof chessPieces[option] === "function" ? (jsxRuntime.jsx("div", Object.assign({ style: {
                transition: "all 0.1s ease-out",
                transform: isHover ? "scale(1)" : "scale(0.85)",
            } }, { children: chessPieces[option]({
                squareWidth: boardWidth / 8,
                isDragging: false,
            }) }))) : (jsxRuntime.jsx("svg", Object.assign({ viewBox: "1 1 43 43", width: boardWidth / 8, height: boardWidth / 8, style: {
                transition: "all 0.1s ease-out",
                transform: isHover ? "scale(1)" : "scale(0.85)",
            } }, { children: jsxRuntime.jsx("g", { children: chessPieces[option] }) }))) })));
}
...
function PromotionDialog() {
    ...
    return (jsxRuntime.jsx("div", Object.assign({ style: Object.assign({ position: "absolute", top: `${dialogCoords === null || dialogCoords === void 0 ? void 0 : dialogCoords.y}px`, left: `${dialogCoords === null || dialogCoords === void 0 ? void 0 : dialogCoords.x}px`, zIndex: 1000 }, dialogStyles[promotionDialogVariant]), title: "Choose promotion piece" }, { children: promotionOptions.map((option) => (jsxRuntime.jsx(PromotionOption, { option: option }, option))) })));
}

const errorImage = {
    whiteKing: (jsxRuntime.jsx("svg", Object.assign({ xmlns: "http://www.w3.org/2000/svg", version: "1.1", style: {
            shapeRendering: "geometricPrecision",
            textRendering: "geometricPrecision",
            imageRendering: "crisp-edges",
        }, viewBox: "0 0 4210 12970", x: "0px", y: "0px", fillRule: "evenodd", clipRule: "evenodd", width: "250", height: "250" }, { children: jsxRuntime.jsx("g", { children: jsxRuntime.jsx("path", { style: {
                    fill: "black",
                    fillRule: "nonzero",
...
function ErrorBoundary({ children }) {
    try {
        ...
        console.log(error);
        return jsxRuntime.jsx(WhiteKing, { showError: true });
    }
}
function WhiteKing({ showError = false }) {
    return (jsxRuntime.jsxs("div", Object.assign({ style: {
            ...
            flexDirection: "column",
                ...
                } }, { children: errorImage.whiteKing })), showError && jsxRuntime.jsx("h1", { children: "Something went wrong" })] })));
}
...
function Board() {
    ...
    return boardWidth ? (jsxRuntime.jsx("div", Object.assign({ style: { perspective: "1000px" } }, { children: jsxRuntime.jsxs("div", Object.assign({ ref: boardRef, style: Object.assign(Object.assign({ position: "relative" }, boardStyles(boardWidth)), customBoardStyle) }, { children: [jsxRuntime.jsx(Squares, {}), jsxRuntime.jsx(Arrows, {}), showPromoteDialog && (jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [jsxRuntime.jsx("div", { onClick: () => {
                                setShowPromoteDialog(false);
                                ...
                                width: boardWidth,
                                height: boardWidth,
                            } }), jsxRuntime.jsx(PromotionDialog, {})] }))] })) }))) : (jsxRuntime.jsx(WhiteKing, {}));
}
...
const ChessboardDnDRoot = ({ customDndBackend, customDndBackendOptions, children, }) => {
    ...
    return backendSet && clientWindow ? (jsxRuntime.jsx(DnDWrapper, Object.assign({ backend: customDndBackend || (isMobile ? TouchBackend : HTML5Backend), context: clientWindow, options: customDndBackend ? customDndBackendOptions : undefined }, { children: children }))) : (jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [" ", children] }));
};
...
function CustomDragLayer({ boardContainer }) {
    ...
    return isDragging && item.id === id ? (jsxRuntime.jsx("div", Object.assign({ style: {
            position: "fixed",
            pointerEvents: "none",
            zIndex: 10,
            left: 0,
            top: 0,
        } }, { children: jsxRuntime.jsx("div", Object.assign({ style: getItemStyle(clientOffset, sourceClientOffset) }, { children: typeof chessPieces[item.piece] === "function" ? (chessPieces[item.piece]({
                squareWidth: boardWidth / 8,
                isDragging: true,
            })) : (jsxRuntime.jsx("svg", Object.assign({ viewBox: "1 1 43 43", width: boardWidth / 8, height: boardWidth / 8 }, { children: jsxRuntime.jsx("g", { children: chessPieces[item.piece] }) }))) })) }))) : null;
}
...
const SparePiece = ({ piece, width, customPieceJSX, dndId, }) => {
    ...
    // hide the default preview
    dragPreview(getEmptyImage(), { captureDraggingState: true });
    return (jsxRuntime.jsx("div", Object.assign({ ref: canDrag ? drag : null, "data-piece": piece, style: { cursor: "move" } }, { children: typeof renderPiece === "function" ? (renderPiece({
            squareWidth: width,
            isDragging,
        })) : (jsxRuntime.jsx("svg", Object.assign({ viewBox: "1 1 43 43", width: width, height: width }, { children: jsxRuntime.jsx("g", { children: renderPiece }) }))) })));
};
...
const Chessboard = react.forwardRef((props, ref) => {
    ...
    const [boardWidth, setBoardWidth] = react.useState(props.boardWidth);
    const boardRef = react.useRef(null);
    const boardContainerRef = react.useRef(null);
    const [boardContainerPos, setBoardContainerPos] = react.useState({
        left: 0,
        top: 0,
    });
    const metrics = react.useMemo(() => { var _a; return (_a = boardRef.current) === null || _a === void 0 ? void 0 : _a.getBoundingClientRect(); }, [boardRef.current]);
    react.useEffect(() => {
    ...
    return (jsxRuntime.jsx(ErrorBoundary, { children: jsxRuntime.jsxs("div", Object.assign({ ref: boardContainerRef, style: {
                display: "flex",
                flexDirection: "column",
                width: "100%",
            } }, { children: [jsxRuntime.jsx("div", { ref: boardRef, style: { width: "100%" } }), jsxRuntime.jsx(ChessboardDnDRoot, Object.assign({ customDndBackend: customDndBackend, customDndBackendOptions: customDndBackendOptions }, { children: boardWidth && (jsxRuntime.jsxs(ChessboardProvider, Object.assign({ boardWidth: boardWidth }, otherProps, { ref: ref }, { children: [jsxRuntime.jsx(CustomDragLayer, { boardContainer: boardContainerPos }), jsxRuntime.jsx(Board, {})] }))) }))] })) }));
});
