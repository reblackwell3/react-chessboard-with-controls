...
var __require2 = ((x) => typeof __require < "u" ? __require : typeof Proxy < "u" ? new Proxy(x, { get: (a, b) => (typeof __require < "u" ? __require : a)[b] }) : x)(function(x) {
...
var import_pretty_format = __toESM2(require_build(), 1);
var diff$1 = __toESM2(require_build2(), 1);
...
var import_pretty_format2 = __toESM2(require_build(), 1);
var loupe = __toESM2(require_loupe(), 1);
...
__toESM2(require_build(), 1);
__toESM2(require_build2(), 1);
__toESM2(require_loupe(), 1);
...
var Instrumenter = class {
  ...
  invoke(fn, object, call, options) {
    let { callRefsByResult, renderPhase } = this.getState(call.storyId), maximumDepth = 25, serializeValues = (value, depth, seen) => {
      ...
      if (value instanceof ((_a = import_global.global.window) == null ? void 0 : _a.HTMLElement)) {
    ...
    }, info = { ...call, args: call.args.map((arg) => serializeValues(arg, 0, [])) };
...
//# sourceMappingURL=chunk-N7SKHYUJ.js.map
